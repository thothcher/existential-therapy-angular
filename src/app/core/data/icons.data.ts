/* ==========================================================================
   icons.data.ts — the icon set.

   Lucide geometry (24x24, 1.75 stroke, round caps and joins) inlined rather
   than pulled from the 358 KB UMD bundle. Three reasons: it prerenders into
   the static HTML, there is no icon flash on first paint, and only the ~45
   glyphs this platform actually uses are shipped.

   There are no emoji anywhere in this codebase. Every pictogram is a stroke
   icon inheriting currentColor, so it follows both themes for free.
   ========================================================================== */
...
export const ICON_PATHS: Record<string, string> = {
  ...
  /* ---- games ----------------------------------------------------------- */
  puzzle:          '<path d="M15.39 4.39a1 1 0 0 0 1.68-.474 2.5 2.5 0 1 1 3.014 3.015 1 1 0 0 0-.474 1.68l1.683 1.682a2.414 2.414 0 0 1 0 3.414L19.61 15.39a1 1 0 0 1-1.68-.474 2.5 2.5 0 1 0-3.014 3.015 1 1 0 0 1 .474 1.68l-1.683 1.682a2.414 2.414 0 0 1-3.414 0L8.61 19.61a1 1 0 0 0-1.68.474 2.5 2.5 0 1 1-3.014-3.015 1 1 0 0 0 .474-1.68l-1.683-1.682a2.414 2.414 0 0 1 0-3.414L4.39 8.61a1 1 0 0 1 1.68.474 2.5 2.5 0 1 0 3.014-3.015 1 1 0 0 1-.474-1.68z"/>',
  ...
  /* ---- conversation ------------------------------------------------------
     `square` is the stop control: the set had `play` but nothing to end a
     stream with. `phone` is the crisis card, whose entire purpose is a number
     someone can actually call — `mail` was the closest thing here and it is
     not close enough. */
